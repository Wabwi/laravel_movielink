                        ...
                        <div class="row row_1">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item">
                                                <img class="d-block img-fluid"
                                                    src="{{ url('../img/rim_of_the_world.jpg') }}">
                                            ...
                                            <div class="carousel-item">
                                                <img class="d-block img-fluid"
                                                    src="{{ url('../../public/img/rim_of_the_world.jpg') }}">
                            ...
                            <div class="col-sm-4 col-md-8">
                                ...
                                <div class="most_downloaded">
                                    ...
                                    <img src="img/the_informer.jpg" class="img-fluid">
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-striped table-responsive-md">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="img/assimilate.jpg"><img src="img/assimilate.jpg" height="150"></a>
                                        </td>
                                        <td><strong>Assimilate:</strong><br>Action, <br>Thriller<br></td>
                                        <td>9/10</td>
                                        <td>43 Downloads</td>
                                    ...
                                    <tr>
                                        <td><a href="img/avengement.jpg"><img src="img/avengement.jpg" height="150"></a>
                                        </td>
                                        <td><strong>Avengement:</strong><br>Action, <br>Thriller<br></td>
                                        <td>9/10</td>
                                        <td>43 Downloads</td>
                                        <td><a href="" class="btn btn-primary">Download</a></td>
                                    ...
                                    <tr>
                                        <td><a href="img/the_poison_rose.jpg"><img src="img/the_poison_rose.jpg"
                                                    height="150" class="movie_img"></a></td>
                                        <td><strong>The Poison Rose:</strong><br>Thriller<br></td>
                                        <td>9/10</td>
                                        <td>43 Downloads</td>
                                        <td><a href="" class="btn btn-primary">Download</a></td>
